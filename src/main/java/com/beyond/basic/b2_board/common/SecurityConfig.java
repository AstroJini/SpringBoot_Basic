...
//                cors: 특정 도메인에 대한 허용정책, postman은 웹 브라우저가 아니기 때문에 cors정책에 적용 x
                ...
                // csrf(보안공격 중 하나로서 타사이트의 쿠키값을 꺼내서 탈취하는 공격) 비활성화
                ...
                .exceptionHandling(e->
                        e.authenticationEntryPoint(jwtAuthenticationHandler) //401 ERROR
                         .accessDeniedHandler(jwtAuthorizationHandler) //403 ERROR
                )
                // 예외 api 정책 설정
